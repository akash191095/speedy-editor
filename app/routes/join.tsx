...
import BG from "~/assets/bg1-comp.jpg";
...
export default function Join() {
  ...
  return (
    <main className="flex max-h-[calc(100vh-64px)] justify-center items-center">
      <div className="hidden min-h-[calc(100vh-64px)] basis-2/5 md:flex lg:basis-3/5">
